...
export const olehOlehData: OlehOlehItem[] = [
  {
    id: 1,
    nama: "Batik Tuban",
    ...
    tempatBeli: [
      ...
      "Toko Batik Sumber Rejeki - Jl. Sunan Bonang No. 15",
      "Galeri Batik Nusantara - Jl. Ahmad Yani No. 88"
    ]
  },
  {
    id: 2,
    ...
    tempatBeli: [
      ...
      "Toko Keramik Mas Tohir - Jl. Raya Plered",
      "Galeri Keramik Tuban Jaya - Jl. Basuki Rahmat No. 25"
    ]
  },
  {
    id: 3,
    nama: "Krupuk Rambak Khas",
    ...
    tempatBeli: [
      ...
      "Toko Kerupuk Bu Lastri - Jl. Kartini No. 18",
      "Kerupuk Tuban Original - Pasar Tuban"
    ]
  },
  {
    id: 4,
    ...
    tempatBeli: [
      ...
      "Galeri Tenun Ibu Sari - Jl. Veteran No. 40",
      "Toko Tenun Nusantara - Jl. Gajah Mada No. 22"
    ]
  },
  {
    id: 5,
    nama: "Gula Kelapa Aren",
    deskripsi: "Gula kelapa aren murni tanpa campuran bahan kimia, manis alami khas Tuban.",
    deskripsiDetail: "Gula kelapa aren Tuban diproduksi secara tradisional dari nira aren pilihan. Proses pembuatannya tanpa bahan pengawet sehingga aman dan sehat untuk dikonsumsi.",
    images: [
      "/images/oleh-oleh/gula-aren-1.jpg",
      "/images/oleh-oleh/gula-aren-2.jpg",
      "/images/oleh-oleh/gula-aren-3.jpg"
    ],
    tempatBeli: [
      "Koperasi Gula Aren Tuban - Desa Sumberejo",
      "Toko Hasil Bumi Pak Bambang - Jl. Dewi Sartika No. 12",
      "Pasar Tradisional Tuban - Jl. Pasar"
    ]
  },
  {
    id: 6,
    nama: "Anyaman Bambu",
    deskripsi: "Berbagai kerajinan anyaman bambu seperti tas, tempat nasi, dan hiasan rumah.",
    deskripsiDetail: "Kerajinan anyaman bambu Tuban dibuat dengan teknik tradisional yang telah diwariskan turun temurun. Bambu yang digunakan adalah bambu pilihan yang tahan lama.",
    images: [
      "/images/oleh-oleh/anyaman-bambu-1.jpg",
      "/images/oleh-oleh/anyaman-bambu-2.jpg",
      "/images/oleh-oleh/anyaman-bambu-3.jpg"
    ],
    tempatBeli: [
      "Sentra Kerajinan Bambu Desa Bangilan",
      "Toko Kerajinan Pak Suradi - Jl. Sunan Kalijaga No. 35",
      "Galeri Kerajinan Bambu - Jl. Panglima Sudirman No. 18"
    ]
  }
];
